    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <%if(sf.equals("管理员")){%>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 库房信息管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="javascript:void(0)" name="<%=basePath%>admin/kf/index.jsp" class="iframeurl"><i class="icon-double-angle-right"></i>库房信息管理</a></li>
                            <li class="home"><a  href="javascript:void(0)" name="<%=basePath%>admin/kf/add.jsp?method=addkf" class="iframeurl"><i class="icon-double-angle-right"></i>增加库房信息</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text"> 库存统计分析 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
